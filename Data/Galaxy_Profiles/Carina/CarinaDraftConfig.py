...
CONFIG = {
    ...
    "STELLAR_MODEL": {
        ...
        "grid_csv": str(PROFILE_ROOT / "carina_oden_kirchen2001_axisymmetric_light_grid_full.csv"),
        "Ltot": 2.7e5,
    ...
    # =========================================================
    "SURFACE_BRIGHTNESS_CSV": str(PROFILE_ROOT / "carina_oden_kirchen2001_surface_brightness_profile.csv"),
    "KINEMATIC_BINS_CSV":     str(PROFILE_ROOT / "carina_walker2023_kinematic_bins_20.csv"),
    ...
    **build_data_paths(PROFILE_ROOT),
    "DATA_CSV": str(PROFILE_ROOT / "carina_walker2023.csv"),
    "COMPARISON_TAG": "nonsingular_isothermal_full_light",
    "CSV_PATH": str(PROFILE_ROOT / "default" / "carina_nonsingular_isothermal_full_light.csv"),
}
