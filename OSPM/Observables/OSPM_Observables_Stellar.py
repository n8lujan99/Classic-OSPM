...
def _stellar_geometry_group(geometry):
    ...
    spherical_geometries = {
        ...
        "spherical_abel_grid",
        "spherical_enclosed_light_grid",
        "spherical_force_flattened_grid_metadata",
    }
...
class OSPMObservablesStellar:
    ...
    def from_star_table(
        ...
        *,
        ...
        Norbit,
        stellar_model=None,
        surface_brightness_path=None,
        kinematic_bins_path=None,
        config=None,
    ):
        ...
        return cls(
            ...
            kinematic_bins=kinematic_bins,
            dynamical_mode=None if config is None else config.get("DYNAMICAL_MODE"),
            motion_model=None if config is None else config.get("MOTION_MODEL"),
            v_star_raw_kms=v_raw,
            v_motion_model_kms=v_model,
        )