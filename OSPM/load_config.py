...
# --------------------------------------------------
DECK_RESULT_COLUMNS = [ "chi2", "reward", "status", "proposal_id",
    # Scientific score and solver diagnostics
    "chi2_losvd", "delta_chi2_iteration", "max_light_relative_residual", "max_light_sigma_residual", "light_constraint_ok", "solver_converged", "solver_iterations", "solver_failure_reason", "julia_status_code",
    ...
    "halo_type", "alphat", "light_rel_tol", "light_sigma_tol", "delta_chi2_iter_tol", "halo_q_axis_ratio", "karl_halo_params_active",
    # Orbit-library coverage diagnostics
    "coverage_status", "coverage_strict", "coverage_issue_region", "coverage_issue_axis", "coverage_issue_shell_bands", "coverage_reasons", "coverage_fraction",
    "coverage_attempted_fraction", "coverage_success_fraction", "coverage_shell_min", "coverage_lfrac_min", "coverage_theta_min", "coverage_shell_gap", "coverage_lfrac_gap",
    "coverage_theta_gap", "coverage_joint_holes", "coverage_deadline_hit", "successful_base_orbits", "planned_base_orbits",
